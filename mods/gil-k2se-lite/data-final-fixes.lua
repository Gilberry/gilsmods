...
local ammo_pictures = {
    ["kr-imersite-rounds-magazine"] = {
        layers = {
            { filename = "__gil-k2se-lite__/graphics/icons/ammo/imersite-rounds-magazine.png", size = 64, scale = 0.5 },
    ...
    ["plutonium-atomic-artillery-shell"] = {
        layers = {
            { filename = "__gil-k2se-lite__/graphics/icons/ammo/plutonium-atomic-artillery-shell.png", size = 64, scale = 0.5 },
            { filename = "__Krastorio2Assets__/icons/ammo/antimatter-artillery-shell-light.png", size = 64, scale = 0.5, draw_as_light = true }
        }
    },
...
if recipe then
    recipe.icon = "__gil-k2se-lite__/graphics/icons/ammo/iridium-piledriver.png"
    recipe.icon_size = 64
end
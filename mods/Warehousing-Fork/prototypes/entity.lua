...
ICONPATH = "__Warehousing-Fork__/graphics/icons/"
ENTITYPATH = "__Warehousing-Fork__/graphics/entity/"
local sounds = require("__base__/prototypes/entity/sounds")
local hit_effects = require ("__base__.prototypes.entity.hit-effects")

-- slot counts
local warehouse_slots = 800
local storehouse_slots = 150
local storage_warehouse_slots = 1600
local storage_storehouse_slots = 300
